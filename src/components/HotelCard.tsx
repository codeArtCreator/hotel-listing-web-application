...
const HotelCard: React.FC<HotelCardProps> = ({ property }) => {
    const { id, name, location, popular, facility, rent, image } = property;
            ...
            <Link to={`/property/${id}`}>
                <div className="bg-white rounded-2xl shadow-lg p-4 hover:shadow-md card-container relative">
                    <img
                        src={image}
                        alt={name}
                        className="rounded-2xl w-full h-60 object-cover mb-2"
                    />
                    <div className="p-4">
                        ...
                        <div className="mt-2 flex justify-between items-center">
                            <p>
                                ...
                                <span className="font-semibold">{facility.rooms || 'N/A'}</span>{' '}Room
                            </p>
                            <p>
                                ...
                                <span className="font-semibold"> {facility.beds || 'N/A'}</span>{' '}Bed
                            </p>
                            <p>
                                ...
                                <span className="font-semibold">{facility.bathrooms || 'N/A'}</span>{' '}Bath
                            </p>
                            <p>
                                ...
                                <span className="font-semibold">{facility.sqft || 'N/A'}</span>{' '}sft
                            </p>
                        </div>
                        <div className="flex justify-between items-center">
                            <div className="mt-4">
                                <span className="text-xl text-blue-700 font-semibold">${rent}</span><span> / month</span>
                            </div>
